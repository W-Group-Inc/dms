        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                ...
                <tr><td><b>System Name</b></td><td>Dormitory Management System</td></tr>
                <tr><td><b><?php echo $lang['version']; ?></b></td><td><?php echo $options['app_version']; ?></td></tr>
              <tr><td colspan=2><center><img src="<?php echo base_url(); ?>assets/usr_pics/478b5af37cc63fc14318d5e0edc532fa.png" class="text_center width20"></center></td></tr>
                </table>
            </div>
            <!-- /.box-body -->
          </div>
