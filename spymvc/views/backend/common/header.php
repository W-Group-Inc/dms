...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-4 sidebar-light-indigo">
    ...
    <img src="<?php echo base_url(); ?>assets/usr_pics/478b5af37cc63fc14318d5e0edc532fa.png" alt="DHPMS Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">W DMS</span>
    </a>
    <div class="sidebar">
